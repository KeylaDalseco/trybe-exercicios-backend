    ...
    describe('#verifyLogin', function () {
        it('ao não receber um e-mail, retorne um erro', function () {
            return __awaiter(this, void 0, void 0, function () {
                var parameters, serviceResponse;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            parameters = login_mock_1.default.noEmailLoginBody;
                            return [4 /*yield*/, login_service_1.default.verifyLogin(parameters)];
                        case 1:
        ...
        it('ao não receber uma senha, retorne um erro', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            parameters = login_mock_1.default.noPasswordLoginBody;
                            return [4 /*yield*/, login_service_1.default.verifyLogin(parameters)];
                        case 1:
                            serviceResponse = _a.sent();
                            // Assert
        ...
        it('ao receber um email inexistente no db, retorne um erro', function () {
            return __awaiter(this, void 0, void 0, function () {
                var parameters, serviceResponse;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            parameters = login_mock_1.default.notExistingUserBody;
                            return [4 /*yield*/, login_service_1.default.verifyLogin(parameters)];
                        case 1:
                            serviceResponse = _a.sent();
                            // Assert
